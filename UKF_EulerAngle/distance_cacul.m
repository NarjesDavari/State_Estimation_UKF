...
%point
function [ Simulation ] = distance_cacul( Simulation )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    %P(:,1):position along north(Xn)
    %P(:,2):position along east(Xe)
    %P(:,3):position along up(h)
    P(:,1)=Simulation.Input.Measurements.Ref_Pos(:,2);
    P(:,2)=Simulation.Input.Measurements.Ref_Pos(:,3);
    P(:,3)=Simulation.Input.Measurements.Ref_Pos(:,4); 
