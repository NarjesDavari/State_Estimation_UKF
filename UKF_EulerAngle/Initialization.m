...
%             Simulation.Output.User_Def_Sim.Kalman_mtx.P = diag([1,0.01,0.01,0.01,0.018773,0.018773,0.018773]);
            Cpos=Simulation.Init_Value.Init_P.pos;
            Cdep=Simulation.Init_Value.Init_P.dep;
            Cvel=Simulation.Init_Value.Init_P.vel;
            Cattit=Simulation.Init_Value.Init_P.attit;
            Cba=Simulation.Init_Value.Init_P.ba;
            Cbg=Simulation.Init_Value.Init_P.bg;
            b1=1e-10;b2=1e-10;b3=1e-2;b4=1e-2;b5=1e-2;b6=1e-2;b7=1e-2;b8=1e-2;b9=1e-2;b10=1e-2;b11=1e-2;b12=1e-2;b13=1e-2;b14=1e-2;b15=1e-2;
            Simulation.Output.Kalman_mtx.P = zeros(15,15);
            Simulation.Output.Kalman_mtx.P(1,1) = Cpos; %%1e-6*b1;
            Simulation.Output.Kalman_mtx.P(2,2) = Cpos; %%1e-6*b2;
            Simulation.Output.Kalman_mtx.P(3,3) = Cdep; %%1e-6*b3;
            Simulation.Output.Kalman_mtx.P(4,4) = Cvel; %%1e-6*b4;
            Simulation.Output.Kalman_mtx.P(5,5) = Cvel;%%1e-6*b4;
            Simulation.Output.Kalman_mtx.P(6,6) = Cvel*1e-2;%%1e-6*b4;
            Simulation.Output.Kalman_mtx.P(7,7) =  Cattit; %%1e-6*b5;
            Simulation.Output.Kalman_mtx.P(8,8) = Cattit; %%1e-6*b5;
            Simulation.Output.Kalman_mtx.P(9,9) =  Cattit; %%1e-6*b5;
            Simulation.Output.Kalman_mtx.P(10,10) = Cba; %%1e-6*b6;
            Simulation.Output.Kalman_mtx.P(11,11) = Cba;%% 1e-6*b6;
            Simulation.Output.Kalman_mtx.P(12,12) =  Cba;%%1e-6*b6;
            Simulation.Output.Kalman_mtx.P(13,13) =  Cbg; %%1e-6*b7;
            Simulation.Output.Kalman_mtx.P(14,14) =  Cbg; %%1e-6*b7;
            Simulation.Output.Kalman_mtx.P(15,15) =  Cbg; %%1e-6*b7;
...
%                Simulation.Output.Kalman_mtx.P(13,13) Simulation.Output.Kalman_mtx.P(14,14)  Simulation.Output.Kalman_mtx.P(15,15)];
            ...
            Simulation.Output.UKF.X(1,10:12)=1e-5; %% 1e-2 is good value
            Simulation.Output.UKF.X(1,13:15)=1e-5; %% 1e-3 is good value
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
%             Simulation.Output.Kalman_mtx.V=zeros(Dlength-ave_sample +1,15);
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            W0 = 0.1;
            [sigma,W2,WM2,WC2] = Weight_cal (W0,length(x1),alpha,beta);
