...
function [x_dot , fnn , Wnb_b] = Navigation_f( x_ , C_ , fb , Wib_b , gl, Q ,dt )
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     x_dot(10,:) = 0;%sqrt(Q(10,10))*rand(1);%%sqrt(Qc.q_Bax)*rand(1);
%     x_dot(11,:) = 0;%sqrt(Q(11,11))*rand(1);%%sqrt(Qc.q_Bay)*rand(1);
%     x_dot(12,:) = 0;%sqrt(Q(12,12))*rand(1);%%sqrt(Qc.q_Baz)*rand(1);
%     x_dot(13,:) = 0;%sqrt(Q(13,13))*rand(1);%%sqrt(Qc.q_Bwx)*rand(1);
%     x_dot(14,:) = 0;%sqrt(Q(14,14))*rand(1);%%sqrt(Qc.q_Bwy)*rand(1);
%     x_dot(15,:) = 0;%sqrt(Q(15,15))*rand(1);%%sqrt(Qc.q_Bwz)*rand(1);
%     Tca = 100; Tcg=100;
