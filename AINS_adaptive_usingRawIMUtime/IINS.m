...
function [Simulation]=IINS(Simulation,coeff_final,include_MA)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                             hdng_Time  = num2str(Simulation.Input.Measurements.Heading(Simulation.Input.Measurements.hdng_Counter,1));
                        ...
                        if  flag_fusion_GPS==1  || flag_fusion_depth==1 ||  flag_fusion_DVL==1 ||  flag_fusion_hdng==1 
                          ...
                          if flag_fusion==1  || flag_fusion2==1 %%%I==2  || 
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
    ...
    % %                             [ Simulation ] = R_Moving( Simulation );
                            ...
                            Simulation.Input.Measurements.IMU2(I2,:)=Simulation.Input.Measurements.IMU(I_new,:);
                            I2=I2+1;
                          end
                           I=I+1;
                   end
